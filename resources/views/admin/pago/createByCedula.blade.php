...
@extends('layouts.admin')
	...
	<div class="container-form">	
        ...
        <a href="/viajero/detalles/{{$id}}" class="btn btn-default">
	        ...
	        <div class="modal-content">
	          ...
	          <div class="modal-body">                    	               
                        ...
                        <div class="form-group">
                            {!!Form::label('Cédula:')!!}
                            {!!Form::text('cedula', $cedula, ['class'=>'form-control','placeholder'=>'Ej: 10000000 (sólo números)', 'required']) !!}
                        </div>
	          ...
	          <div class="modal-footer">
	          		...
	          		<a href="/viajero/detalles/{{$id}}" class="btn btn-default"> Atrás </a>
